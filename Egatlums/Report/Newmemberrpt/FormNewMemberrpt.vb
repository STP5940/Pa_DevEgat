...
Public Class FormNewMemberrpt
    ...
    Private Sub FormNewMemberrpt_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.WindowState = FormWindowState.Maximized

    End Sub
    Private Sub Tstcnottime_CheckedChanged(sender As Object, e As EventArgs)

    End Sub
    Private Sub Tscbusergroup_KeyPress(sender As Object, e As KeyPressEventArgs)
        e.Handled = True
    End Sub
