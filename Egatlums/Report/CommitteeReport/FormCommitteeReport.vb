...
Public Class FormCommitteeReport
    ...
    Private Sub FormCommitteeReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Tsbreports_Click(sender As Object, e As EventArgs) Handles Tsbreports.Click
        ...
        ReportViewer1.LocalReport.ReportEmbeddedResource = "Egatlums.RptCommitteereport.rdlc"
